...
public abstract class AbstractTimeEaterCard extends CustomCard {
    ...
    public AbstractTimeEaterCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheTimeEater.Enums.TIME_EATER_COLOR);
    }

    public AbstractTimeEaterCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
    ...
    public void moveToDiscardPile() {
        ...
        if (p instanceof TheTimeEater){
            ...
            if (tp.tempo == TheTimeEater.tempos.REWIND){
                this.target_x = (float) CardGroup.DRAW_PILE_X;
            }
        }
